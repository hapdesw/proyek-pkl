<x-app-layout>
        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden ml-5 flex flex-col min-h-screen ">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            ...
                            <button type="button" class="flex items-center justify-center text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 focus:outline-none dark:focus:ring-primary-800">
                        ...
                        <tbody id="table-body">
                            @forelse ($permohonan as $pm)
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ $pm->status }}</td>
                                    <td class="px-4 py-3">{{ $pm->tanggal_awal }}</td>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="text-center py-3">Tidak ada permohonan</td>
                            </tr>
                            @endforelse
