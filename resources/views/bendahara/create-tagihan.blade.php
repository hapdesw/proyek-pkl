            ...
            <form action="{{route ('bendahara.tagihan.store', ['id' => $permohonan->id]) }}" method="POST" class="space-y-4" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-5">
                    ...
                    <div>
                        ...
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="file_input" type="file" name="file_tagihan" accept=".pdf">
