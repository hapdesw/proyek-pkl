<x-app-layout>
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12"> 
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden ml-80 mr-80 flex flex-col min-h-10">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form action="{{ route('admin.kelola-layanan') }}" method="GET" class="flex items-center">
                        ...
                        @forelse ($jenislayanan as  $index => $layanan)
                            ...
                            <tr class="border-b dark:border-gray-700 text-darkKnight">
                                ...
                                <td class="px-4 py-3 flex items-center">
                                    ...
                                    <div id="actions-dropdown-{{ $layanan->id }}" class="hidden z-10 w-auto bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
            ...
            <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4">
                ...
                <ul class="inline-flex items-stretch -space-x-px">
                    <li>
                        <a href="{{ $jenislayanan->previousPageUrl() }}{{ request('search') ? '&search=' . request('search') : '' }}"
                            class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-gray-900 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 {{ $jenislayanan->onFirstPage() ? 'cursor-not-allowed opacity-50' : '' }}">
                    ...
                    {{-- Next Page Link --}}
                    <li>
                        <a href="{{ $jenislayanan->nextPageUrl() }}{{ request('search') ? '&search=' . request('search') : '' }}"
                            class="flex items-center justify-center h-full py-1.5 px-3 leading-tight text-gray-900 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 {{ !$jenislayanan->hasMorePages() ? 'cursor-not-allowed opacity-50' : '' }}">
