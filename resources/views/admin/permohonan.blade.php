                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    ...
                                    function initializeFiltersFromUrl() {
                                        ...
                                        if (urlParams.has('status_permohonan')) {
                                            statusPermohonanSelect.value = urlParams.get('status_permohonan');
                                        }
                                    ...
                                    // Fungsi update badge filter aktif
                                    function updateActiveFiltersBadge() {
                                        ...
                                        if (urlParams.has('status_permohonan')) {
                                            ...
                                            if (statusValue === 'Diproses') {
                                                ...
                                                statusText = 'Batal';
                                                badgeClass += ' bg-red-50 text-red-800 border-red-200 hover:bg-red-100';
                                            }
                                            ...
                                            if (statusText) {
                                                ...
                                                removeBtn.onclick = () => removeFilter('status_permohonan');
                                    ...
                                    applyFilterButton.addEventListener('click', function() {
                                        ...
                                        statusPermohonanSelect.value 
                                            ? url.searchParams.set('status_permohonan', statusPermohonanSelect.value) 
                                            : url.searchParams.delete('status_permohonan');
                            ...
                            <div id="exportModal" class="fixed inset-0 z-50 flex items-center justify-center hidden" style="margin: 0; padding: 0;">
                                ...
                                <div class="relative bg-white rounded-lg shadow-lg p-6 w-96 m-4">
                                    ...
                                    <div id="exportButtons" class="hidden flex justify-center gap-5 mb-6">
                                        <a href class="bg-redNew hover:bg-red-300 text-white hover:text-orange-700 font-bold py-2 px-4 rounded">PDF</a>
                                        <a href class="bg-green-500 hover:bg-green-300 text-white hover:text-green-700 font-bold py-2 px-4 rounded">Excel</a>
                                    </div>
