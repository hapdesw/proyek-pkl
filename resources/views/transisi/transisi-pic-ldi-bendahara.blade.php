...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <form id="role-form" action="{{ route('pilih-role') }}" method="POST" class="flex space-x-8">
        ...
        <button type="submit" onclick="setRole('0100')" class="bg-white rounded-lg shadow-lg w-64 h-64 flex flex-col items-center justify-center hover:bg-red-100 transition">
        ...
        <button type="submit" onclick="setRole('0001')" class="bg-white rounded-lg shadow-lg w-64 h-64 flex flex-col items-center justify-center hover:bg-lime-100 transition">
